...
| --- | --- |
| `make test` | starts a test MongoDB in Docker (port 27018, db `tenebrae_test`), runs the suite against it — every test needs it, there is no base-less mode |
...
| `make coverage` | the suite measured over `tenebrae/`; `htmlcov/index.html` |
