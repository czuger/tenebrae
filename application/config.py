...
`TestingConfig` sets "fake", and the tests are the only place it can be used from.
"""
...
class TestingConfig(Config):
    ...
    # The test player fixes the map just as they play: it is `tests/conftest.py` that puts this
