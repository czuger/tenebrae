...
The counterpart of `engine/repositories/`, for what is not the game. Same rules, and for the same
reasons: a repository exchanges **dicts**, never a MongoEngine Document, and each subject has two
...
persistence must not load mongoengine for all that.
    ...
    from repositories.view import MongoViewRepository, InMemoryViewRepository
"""
