...
class MongoViewRepository:
    ...
    def __init__(self):
        ...
        # require mongoengine, which the base-less tests have no reason to load.
...
class InMemoryViewRepository:
    ...
    Held by `PERSISTENCE=none` and by the tests: the view holds for this run, and vanishes with
    ...
    def clear(self):
        """Forgets every view. The repository living as long as the application - which the tests
