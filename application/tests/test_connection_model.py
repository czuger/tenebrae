...
These tests bear on the class alone, with no request and no route - as `engine/tests/test_seats.py`
...
the engine's in-memory repository, which is the tests' real repository.
