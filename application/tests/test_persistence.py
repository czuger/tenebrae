...
These tests run on mongomock - an in-memory MongoDB -, no server is required. They are the only
...
from engine.hexagon import Hex  # noqa: E402
from engine.phase import COMBAT, MOVEMENT  # noqa: E402
...
# - nor the round trip of dates. These tests do, when a base is reachable; otherwise they skip
