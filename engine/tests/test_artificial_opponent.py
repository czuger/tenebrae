...
The file is not called `test_ai.py`: `application/tests/` already has one, and pytest imports test
...
from engine.combat import DE, DR, CombatRegister
from engine.hexagon import MAP, Hex
from engine.phase import Turn
from engine.piece import piece
from engine.tests.plains import ring_of, surroundings, well_surrounded_plain
