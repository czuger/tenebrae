...
from engine.hexagon import (DEFAULT_MOVEMENT, MAP, TRANSCRIBED_MAP, Hex, apply_fixes, read_fixes)

# Reference hexagons, read off the game map - the fixed transcription. If a future fix changes one
# of them, these tests will say so: another one must then be chosen, not the fix undone.
