...
These tests keep the placement consistent with the map: a terrain fix that would put a unit in a
lake would show up here, and not mid-game.
"""

import pytest

from engine.hexagon import MAP, UNINHABITABLE, Hex
from engine.piece import ALLIANCE, CATALOGUE, DARKNESS
from engine.scenario import SCENARIOS, Scenario, available_scenarios, read, scenario
...
# it to the other. The tests redraw it rather than copy it out - it is the line that is the
