...
import - the Mongo repositories import their document lazily -, so `tenebrae/application/app.py`
imports both and an application mounted without persistence still builds without mongoengine.
