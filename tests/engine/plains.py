"""Terrain landmarks for the movement engine - no test here, only what it takes to write some.

The reference hexagons are not hard-coded: they are looked up on the game map, so that the engine
